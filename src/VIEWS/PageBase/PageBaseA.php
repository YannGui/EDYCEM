...
class PageBaseFuncs
{
  ...
  public static function GetMenu($idUser)
  {
   ...
   if($_SERVER['REQUEST_URI'] == '/VIEWS/LogOn/DASHBOARD/user.php' || $_SERVER['REQUEST_URI'] == '/VIEWS/LogOn/ADD/User.php' || $_SERVER['REQUEST_URI'] == '/VIEWS/LogOn/ADD/PlaceForUser.php' || substr($_SERVER['REQUEST_URI'], 0, 26) == '/VIEWS/LogOn/EDIT/user.php')
{
